    ...
    try {
      ...
      await emailjs.send(
        ...
        "template_17us8im",
        {
          ...
          to_email: "your.email@example.com", // 🔁 Replace with your actual email if you want
      ...
      <div className="flex flex-col items-center justify-center max-w-md p-5 mx-auto border border-white/10 rounded-2xl bg-primary">
        <div className="flex flex-col items-start w-full gap-5 mb-10">
          ...
          <p className="font-normal text-neutral-400">
            Whether you're building something fresh, refining an idea, or just want to chat about dev stuff — I’m down to talk.
          </p>
        </div>
